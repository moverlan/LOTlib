...
class LOTHypothesis(FunctionHypothesis):
    ...
    """
    NoCopy = {'self', 'grammar', 'func', 'proposal_function', 'pyfunc'} # These are things we don't copy

    def __init__(self, grammar, maxnodes):
        pass
    ...
    #def __copy__(self, copy_value=True):
        ...
        #thecopy = type(self)(self.grammar, value=copy.copy(self.value) if copy_value else self.value, f=self.f, proposal_function=self.proposal_function)
